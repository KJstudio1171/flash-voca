...
export default function HomeScreen() {
  ...
  return (
    ...
    >
      <Panel accentColor={quickStudyDeck?.accentColor ?? tokens.colors.primary}>
      ...
      <View style={styles.statGrid}>
        <Panel style={styles.statCard}>
          ...
          <Text style={styles.statLabel}>available decks</Text>
        </Panel>
        <Panel style={styles.statCard}>
          <Text style={styles.statValue}>{bundles.length}</Text>
          <Text style={styles.statLabel}>store bundles</Text>
        </Panel>
      </View>

      <Panel>
        <Badge tone="info">Next Focus</Badge>
        <Text style={styles.sectionTitle}>MVP routes already wired</Text>
